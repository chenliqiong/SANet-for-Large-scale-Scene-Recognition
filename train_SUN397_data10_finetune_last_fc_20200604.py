...
===========================================================================
# CLQ-20200604   training SUN397     data10
nohup python -W ignore train_SUN397_data10_finetune_last_fc_20200604.py -a sksa_resnet101 --data /mnt/disk/home1/clq/datasets/SUN397/data10/ \
--epochs 100 --schedule 30 60 90 95  --lr 0.1 --train-batch 256 --test-batch 256 \
--gamma 0.1 -c checkpoints/SUN397/data10_sksa_resnet101_finetune_last_fc --gpu-id 1 \
>train_log_SUN397_data10_20200604.txt 2>&1 &
