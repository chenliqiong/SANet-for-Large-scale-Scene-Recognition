...
===========================================================================
# CLQ-20200603   training SUN397     data08
nohup python -W ignore train_SUN397_data08_finetune_last_fc_20200603.py -a sksa_resnet101 --data /mnt/disk/home1/clq/datasets/SUN397/data08/ \
--epochs 100 --schedule 30 60 90 95  --lr 0.1 --train-batch 256 --test-batch 256 \
--gamma 0.1 -c checkpoints/SUN397/data08_sksa_resnet101_finetune_last_fc --gpu-id 1 \
>train_log_SUN397_data08_20200603.txt 2>&1 &
