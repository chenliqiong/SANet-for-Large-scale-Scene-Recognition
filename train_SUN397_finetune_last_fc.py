...
===========================================================================
# training SUN397
（1） take data01 as an example
nohup python -W ignore train_SUN397_finetune_last_fc.py -a sksa_resnet101 --data /mnt/disk/home1/clq/datasets/SUN397/data01/ --epochs 100 --schedule 30 60 90 95  --lr 0.1 --train-batch 256 --test-batch 64 \
--gamma 0.1 -c checkpoints/SUN397/data01_sksa_resnet101_finetune_last_fc --gpu-id 3 \
>log_SUN397_data01.txt 2>&1 &
===========================================================================
